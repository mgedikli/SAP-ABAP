*&---------------------------------------------------------------------*
*& Report ZMG_TEST_215A
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT zmg_test_215a.
*Sayfa 297_Alıştırma – 2: Kendinize ait STRAVELAG database tablosunun (Ör: ZCM_STRAVELAG) bütün kayıtlarını
...
DATA: gt_stravelag     TYPE TABLE OF stravelag,
      ...
      gs_zmg_stravelag TYPE zmg_stravelag,
...
START-OF-SELECTION.
  ...
  LOOP AT gt_stravelag INTO gs_stravelag.
    ...
    MOVE-CORRESPONDING gs_stravelag TO gs_zmg_stravelag.

    gs_zmg_stravelag-id = gv_no.

    INSERT zmg_stravelag FROM gs_zmg_stravelag.
