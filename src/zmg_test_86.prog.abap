...
*                gs_sflight-paymentsum, gs_sflight-seatsmax,   gs_sflight-seatsocc,   gs_sflight-paymentsum,
*                gs_sflight-seatsmax_b, gs_sflight-seatsocc_b, gs_sflight-seatsmax_f, gs_sflight-seatsocc_f.
*        SKIP.
    ULINE.
