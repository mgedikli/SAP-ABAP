*&---------------------------------------------------------------------*
*& Report ZMG_TEST_154_3
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT zmg_test_154_3.
*Container ALV - Class kullanarak ALV olusturma
DATA: go_alvgrid   TYPE REF TO cl_gui_alv_grid,
      go_container TYPE REF TO cl_gui_custom_container,
      gt_fieldcat  TYPE lvc_t_fcat,
      gs_fieldcat  TYPE lvc_s_fcat,  "gs_fieldcat  like line of gt_fieldcat,
...
TYPES:   traffic_light TYPE icon-id. "SAP nin ICON diye bir taplosu var (sflight gibi) ICON tablosu icinde ICONlarla ilgili veri tutuyor.
...
**   IF lines( lt_selected_cells ). "Altrnatif
*
      IF lv_number = 1.
