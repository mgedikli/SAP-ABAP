...
*&
*&---------------------------------------------------------------------*
REPORT zabap_mg_025a.
*Class Tekrar_HR Izin Function_!_1.Asama
PARAMETERS: p_i_bas TYPE sy-datum OBLIGATORY,
            p_i_bit TYPE sy-datum OBLIGATORY,
            p_id    TYPE zcm_de_id OBLIGATORY.

DATA: go_yillik_izin     TYPE REF TO zmgtest_yillik_izin_class, "Clobal Class instance edildi
...
START-OF-SELECTION.
  ...
  CREATE OBJECT go_yillik_izin. "go_yillik_izin"Instance edilen örnek(tanimlama)CREATE OBJECT ile calisir hale getirildi
