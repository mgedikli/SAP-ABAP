*&---------------------------------------------------------------------*
*& Report ZABAP_MG_006D
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ZABAP_MG_006D.

DATA : gv_carname TYPE scarr-carrname, "s_carrname,
       gs_scarr   TYPE scarr,
       gs_spfli   TYPE spfli,
...
SELECTION-SCREEN BEGIN OF BLOCK a1 WITH FRAME TITLE TEXT-001.
  SELECT-OPTIONS : so_cname FOR gv_carname.
...
*      SELECT * FROM spfli APPENDING TABLE gt_spfli WHERE carrid = gs_scarr-carrid.
      CLEAR : gs_scarr.
    ENDLOOP.
