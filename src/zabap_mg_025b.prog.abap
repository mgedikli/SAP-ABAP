*&---------------------------------------------------------------------*
*& Report ZABAP_MG_025B
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ZABAP_MG_025B.
*s.329 Alıştırma – 1: Yeni bir Message Class tanımlayın ve içerisinde senelik izin programında yapılan
...
*HR IZIN Function s.329 Alistirma 1
