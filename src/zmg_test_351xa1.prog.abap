*&---------------------------------------------------------------------*
*& Report ZMG_TEST_351XA1
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT zmg_test_351xa1.
*S.361 Alistirma 14 - change document
  ...
  CASE sscrfields.
    WHEN 'OKU'.
      ...
      IF p_kay_no IS NOT INITIAL.
        ...
        ENDIF.
      ELSE.
        MESSAGE 'Kayit No Girilmedi!' TYPE 'S' DISPLAY LIKE 'E'.
      ENDIF.
...
*    CLEAR: gs_ders_notu_yeni.
  ...
  ELSE.
    ...
    MESSAGE 'Güncelleme Basarisiz; kayit no bulunamadi!' TYPE 'S' DISPLAY LIKE 'E'.
