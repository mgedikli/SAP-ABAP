class ZMGTEST_YILLIK_IZIN_CLASS definition
  public
  final
  create public .
...
CLASS ZMGTEST_YILLIK_IZIN_CLASS IMPLEMENTATION.
  ...
  METHOD izin_kontrol.
    ...
    IF iv_izin_baslangic(4) = iv_izin_bitis(4).           "YYYYMMDD ikisi de ayni yil icerisinde
      ...
      SELECT * FROM zcm_tablo_2
        ...
        WHERE id = iv_id AND                              "Kullanicinin yil aldigi izinler toplamini bulmak icin
              yil = iv_izin_baslangic(4).                 "Sadece mevcut yila ait izin planlamasini isitiyoruz.tüm verileri degil.

      LOOP AT lt_tablo_2 INTO ls_tablo_2.                 "Ayni yil icinde kullandigi izinleri topla
