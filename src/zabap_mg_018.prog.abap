...
*&---------------------------------------------------------------------*
REPORT zabap_mg_018.
*Container ALV Custom Button (Kolon,Satir,Hücre Renklendir)
  ...
  CASE sy-ucomm.
    ...
    WHEN 'K_RENK'.
      ...
      IF lt_index_columns IS NOT INITIAL.
        LOOP AT lt_index_columns INTO ls_index_columns.
          ...
          IF sy-subrc IS INITIAL.
            gs_fieldcat-emphasize = 'C611'. "lv_color.  "Document s:248
        ...
        ENDLOOP.
      ELSE.
        MESSAGE 'EN AZ BİR KOLON SECINIZ.' TYPE 'I'.
      ENDIF.
    ...
    WHEN 'H_RENK'.
      ...
      IF lt_selected_cells IS NOT INITIAL.
        CALL FUNCTION 'ZCM_COLOR_SELECTION_CELL' "Document Alternatifi
*         CALL FUNCTION 'ZZO_COLOR_SELECTION_CELL' "Ders versiyon:renk kodlari (C311-C511.C611) girerek
          IMPORTING
      ...
      IF lines( lt_selected_cells ) = 1.
        ...
        IF sy-subrc IS INITIAL.
          IF ls_selected_cells-col_id = 'PLANETYPE'.
            ...
            ENDIF.
          ELSE.
            MESSAGE 'Sadece PLANE TYPE kolonunda bir HÜCRE secerek FILTRELEME yapabilirsiniz.' TYPE 'I'.
          ENDIF.
        ENDIF.
      ELSE.
