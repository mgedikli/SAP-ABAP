*&---------------------------------------------------------------------*
*& Report ZMG_TEST_322A
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ZMG_TEST_322A.  "zcm_test_327
*Test_322  Eski syntax ile cözümü
*DELETE ADJACENT DUPLICATES FROM ->ID bazinda coklayan tüm satirlari sil demek.
