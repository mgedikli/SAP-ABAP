...
*KONU: INTERNAL Tablo icindeki satiri modifiye etme veya silme:
* SENARYO: 3. satiri oku, 3. satiri ekrana yazdir, daha sonra 3. satiri sil, sonra bir daha 3. satiri oku.
...
*SATIR SILME YÖNTEMI
*DELETE gt_table WHERE plaka_no = '23 DE 3476'. "DELETE komutu ile satir silme islemi yapilabilir.
*
*BREAK-POINT. "BREAK-POINT ile islemin basarili olup olmadigi kontrol edilebilir.
...
*DELETE gt_table. "INDEX verilmezse tablonun tamami silinir ve hicbir zaman bu sekilde kullanilmaz!
...
IF sy-subrc IS INITIAL.
  WRITE: 'Yeni 3. sair', gs_structure-plaka_no, gs_structure-marka, gs_structure-model, gs_structure-renk,
gs_structure-motor_cc, gs_structure-uretim_yili, gs_structure-fiyat, gs_structure-kilometre.
ENDIF.
