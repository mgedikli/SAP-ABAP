*&---------------------------------------------------------------------*
*& Report ZMG_TEST_337X
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ZMG_TEST_337X.
*S.361)Alıştırma – 3: Yeni bir rapor oluşturun. Raporda 5 hücreli bir internal tablo tanımlayın.
*(Örnek: PROJE_ID, PROJE_AD, PROJE_SORUMLUSU, PROJE_PLAN_GUN, PROJE_DEPARTMAN).
*APPEND INITIAL LINE TO komutunu kullanarak bu internal tabloya 5 adet yeni satir ekleyin.
*Daha sonra internal tabloda loop edin ve PROJE_PLAN_GUN kolonundaki her hücreye 5 ekleyin.
*Raporda inline declaration ile tanımlanmış field sembol kullanın.
