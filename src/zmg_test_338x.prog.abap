*&---------------------------------------------------------------------*
*& Report ZMG_TEST_338X
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ZMG_TEST_338X.
*S.361)Alıştırma – 4: Bir önceki alıştırmada manuel olarak hazırlanmış internal tablo için
*manuel olarak field Catalog oluşturun ve Container ALV hazırlayın.
*Field Catalog tablosunu hazırlarken inline declaration ile tanımlanmış field sembol kullanın.
