...
* THIS FILE IS GENERATED. NEVER CHANGE IT MANUALLY, PLEASE!
  ...
  IF UPD_ZCM_DERS_NOTLARI NE SPACE.
    IF ( XZCM_DERS_NOTLARI[] IS INITIAL ) AND
       ( YZCM_DERS_NOTLARI[] IS INITIAL ).
      UPD_ZCM_DERS_NOTLARI = SPACE.
    ENDIF.
  ENDIF.
  ...
  IF UPD_ZCM_DERS_NOTLARI NE SPACE.
    CALL FUNCTION 'CHANGEDOCUMENT_MULTIPLE_CASE'
      EXPORTING
        TABLENAME              = 'ZCM_DERS_NOTLARI'
        CHANGE_INDICATOR       = UPD_ZCM_DERS_NOTLARI
        DOCU_DELETE            = 'X'
        DOCU_INSERT            = 'X'
        DOCU_DELETE_IF         = ''
        DOCU_INSERT_IF         = ''
      TABLES
        TABLE_OLD              = YZCM_DERS_NOTLARI
        TABLE_NEW              = XZCM_DERS_NOTLARI
      EXCEPTIONS
        NAMETAB_ERROR          = 1
        OPEN_MISSING           = 2
  ...
  IF UPD_ICDTXT_ZMG_CDO_01 NE SPACE.
     CALL FUNCTION 'CHANGEDOCUMENT_TEXT_CASE'
       TABLES
         TEXTTABLE              = ICDTXT_ZMG_CDO_01
       EXCEPTIONS
         OPEN_MISSING           = 1
