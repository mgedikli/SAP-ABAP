*&---------------------------------------------------------------------*
*& Report ZMG_TEST_332X
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ZMG_TEST_332X.

*Excel Dosyasi DISA Aktarma
...
START-OF-SELECTION.
  ...
  SELECT * FROM zmg_stravelag INTO TABLE @DATA(gt_table) WHERE agencynum IN @so_agnum.
  ...
  CALL METHOD cl_gui_frontend_services=>gui_download
    EXPORTING
      filename                = 'C:\Users\Mustafa\Desktop\new'
      filetype                = 'ASC'
