...
*      go_class_04 TYPE REF TO zalistirma_cls_mg_04.
...
*
*  go_class_04->gt_carr_id_selopt = so_cid[].
*
...
*
DATA: gv_carrid   TYPE s_carr_id,
      go_class_05 TYPE REF TO zalistirma_cls_mg_05.
...
START-OF-SELECTION.
  ...
  CREATE OBJECT go_class_05.

  go_class_05->gt_carr_id_selopt = so_carr[].

  go_class_05->get_tables(
    EXPORTING
