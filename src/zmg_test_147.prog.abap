...
*&---------------------------------------------------------------------*
REPORT zmg_test_147.
*S-223-Alıştırma – 3: Yeni bir rapor oluşturun ve kullanıcıdan 1 adet sayı alın. Ayrıca 3 adet radiobutton olsun.
...
START-OF-SELECTION.
  ...
  IF p_uzr_2 = abap_true.
    zalistirma_cls_mg_03=>uzeri_2(
      EXPORTING
        iv_number = p_number
      IMPORTING
        ev_result = gv_result ).
  ELSEIF p_uzr_3 = abap_true.
    zalistirma_cls_mg_03=>uzeri_3(
      EXPORTING
        iv_number = p_number
      IMPORTING
        ev_result =  gv_result ).
  ELSE.
    zalistirma_cls_mg_03=>uzeri_4(
      EXPORTING
        iv_number = p_number
      IMPORTING
        ev_result = gv_result ).
