...
*NO INTERVALS yazarak Tablonun gereksiz uzamasi e´önlenmis olur; ayrica, TYPE n LENGTH 2 yaparak kutu kücültülebilir.
*001 üzerine cift tiklayarak Text sembol tablosunda 'Selection Texts' menüsünde 'Pnum' yerine 'Sayi:' ve
...
* Kullanici yanlis sayi (10 dan büyük sayi) girmesi veya sayi girmemesi durumunda uyari mesaji verelim.
*Bunun ici 002 üzerine cift tiklanarak 'Text Symbols' menüsünde mesaj metni olustur.
*EXIT Komutu kullanilir.
