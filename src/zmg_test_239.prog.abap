...
START-OF-SELECTION.
  ...
  SELECT * FROM zcm_stravelag INTO CORRESPONDING FIELDS OF TABLE gt_stravelag. " cnt_name  TYPE c LENGTH 20, eklendigi icin
                                                                               " INTO CORRESPONDING FIELDS OF TABLE
  LOOP AT gt_stravelag INTO gs_stravelag.

    CALL FUNCTION 'IGN_COUNTRYNAME_GET' " ülke kodu ile Ülke ismini bulma
      EXPORTING
