*&---------------------------------------------------------------------*
*& Report ZMG_TEST_351XB
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ZMG_TEST_351XB. "S.346 day 77 basi
*S.361) Alıştırma – 14: ZCM_DERS_NOTLARI tablosundaki SONUC kolonu için data element oluşturun ve bu
*hücrede değişiklik yapacak bir rapor hazırlayın. Rapor içinde aynı zamanda Change Document da
*oluşturulsun. Yapılan değişiklikleri CDPOS tablosunda kontrol edin.
